...
export function useCreateJob2Mutation(options?: {
...
export function useDeleteJob2Mutation(options?: {
...
export function useUpdateJob2Mutation(options?: {
  onSuccess?: (value?: API.CommonResultBoolean) => void;
  onError?: (error?: DefaultError) => void;
}) {
  const { onSuccess, onError } = options || {};
