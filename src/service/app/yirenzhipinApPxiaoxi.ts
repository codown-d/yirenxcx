...
export async function getChatSessionList({
  ...
  return request<API.CommonResultListYRZPMessageSessionRespAppVO>(
    '/app-api/yirenzhipin/message/get-chat-session-list',
    {
      method: 'GET',
      ...(options || {}),
    }
...
export async function getSystemMessageList({
  ...
  return request<API.CommonResultListYRZPMessageSessionRespAppVO>(
    '/app-api/yirenzhipin/message/get-system-session-list',
    {
      method: 'GET',
      ...(options || {}),
    }
